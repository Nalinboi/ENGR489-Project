...
let tabs = [
    ...
    Page(image: "waiting-room", title: "Waiting room", text: "Once you have checked into reception, a nurse will find you shortly."),
    Page(image: "nurse", title: "Triage nurse", text: "A nurse will see you shortly. Here They will triage you. \n\nThis means they will assess your level of severity, and ensure you are safe."),
    Page(image: "bed", title: "Emergency Room", text: "You will be admitted into the emergency room where a doctor will treat you. \n\nThe doctor may also provide you with further information so please take notes of any information given.")
]
