...
//        Gradient(colors: [Color(#colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.6312997341, green: 0.9606612325, blue: 1, alpha: 1))]),
        
        Group {
            if isWalkthroughShowing {
                LinearGradient(gradient:
                   Gradient(colors: [.white, Color(#colorLiteral(red: 0.6312997341, green: 0.9606612325, blue: 1, alpha: 1))]),
